...
function setPaymentDetails(intent) {
  ...
  switch (intent.status) {
    case "succeeded":
      statusText = "Платеж успешен";
      iconColor = "#30B130";
      icon = SuccessIcon;
      break;
    case "processing":
      statusText = "Платеж в обработке.";
      iconColor = "#6D6E78";
      icon = InfoIcon;
      break;
    case "requires_payment_method":
      statusText = "Платеж не прошел. Попробуйте снова.";
      break;
    default:
      break;
  }
...
function setErrorState() {
  ...
  document.querySelector("#status-text").textContent= "Что-то пошло не так. Попробуйте еще раз.";
